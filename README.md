...
The algorithm works by transforming the problem to only work on the $N-1$ normalized direction vectors $\mathbf z $ of each link in the chain, and performing staggered newton-like steps on this formulation. Read the technical description [here.](https://silcowitz.github.io/reposition/solve.pdf)
